...
class MainWindow(QMainWindow):
    ...
    # TODO adapter cette méthode pour la suppression de plusieurs courbes à la fois.
    # en : Method that delete a checkbox when deleting a curve.
    # TODO adapt this method for deleting multiple curves at once.
